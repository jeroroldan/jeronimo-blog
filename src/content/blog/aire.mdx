...
import aogenerative from '../../assets/aogenerative.png';
...
- 🛠️ Herramientas, técnicas y mejores prácticas recomendadas
- 📝 Ejemplos guiados paso a paso
- ⚠️ Errores comunes, anti-patrones y cómo evitarlos


<div class="concept-hero">
	<Image
		src={aogenerative}
		alt="AI Engineering: de los modelos fundacionales a sistemas en producción"
		width={800}
		height={450}
		format="png"
	/>
...
| Módulo | Tema | ⏱️ Duración aprox. en el video |
|---|---|---|
| 1️⃣ | 🧱 Fundamentos del AI Engineering | 0:00 – 8:40 |
| 2️⃣ | 📊 Evaluación y Selección de Modelos | 8:40 – 23:15 |
| 3️⃣ | 🔍 Prompt Engineering y RAG | 23:15 – 36:56 |
| 4️⃣ | 🤖 Agentes y Memoria | 36:56 – 43:02 |
| 5️⃣ | 🎛️ Fine-tuning e Ingeniería de Datasets | 43:02 – 59:45 |
| 6️⃣ | ⚡ Optimización de Inferencia y Arquitectura de Sistemas | 59:45 – 1:16:03 |
...
### 1.3 🏗️ La arquitectura Transformer
...
### 2.3 ⚖️ AI como Juez — cómo implementarlo bien
...
### 3.3 🗂️ RAG: arquitectura y funcionamiento
...
## 🎛️ Módulo 5 — Fine-tuning e Ingeniería de Datasets
...
### 5.3 🗃️ Ingeniería de datasets: la parte que más importa y menos se ve
...
### 6.1 ⚖️ El trade-off central: latencia vs. throughput vs. costo
...
### 6.3 🏎️ Decodificación especulativa (speculative decoding)
...
## 🗓️ Hoja de ruta de aprendizaje sugerida
...
3. 🗂️ **Semana 4–5**: Construir un pipeline RAG simple end-to-end sobre tus propios documentos (Módulo 3.3).
4. 🤖 **Semana 6**: Construir un agente básico con 1-2 herramientas (calculadora + búsqueda) (Módulo 4).
5. 🎛️ **Semana 7–8**: Si tu caso de uso lo justifica, experimentar con fine-tuning vía LoRA sobre un modelo open-weight chico (Módulo 5).
...
- ⚙️ Documentación de motores de inferencia con batching continuo: vLLM, TensorRT-LLM
- 🛠️ Frameworks de RAG y agentes para experimentar: LangChain, LlamaIndex
