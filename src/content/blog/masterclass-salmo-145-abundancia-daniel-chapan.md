---
title: "MASTERCLASS: El Poder del Salmo 145 — Atraer Abundancia con el Rabino Daniel R. Chapán"
description: "Guía masterclass basada en la charla del Rabino Daniel R. Chapán sobre el Salmo 145 como herramienta espiritual para atraer abundancia: estructura hebrea, valor numérico, intención consciente y práctica diaria con Poteaj et iadeja."
pubDate: "2026-07-03"
code: "salmo-145-abundancia-daniel-chapan"
category: "desarrollo-personal"
tags: ["kabbalah", "salmos", "abundancia", "espiritualidad", "daniel-chapan", "salmo-145", "proposito-vital", "creadores-podcast"]
...
> **Advertencia educativa** — Este contenido es formativo y espiritual. No sustituye asesoría religiosa, psicológica ni financiera profesional. Úsalo como marco de reflexión y práctica personal.

---

## MAPA DEL WORKFLOW DEL SALMO 145

```mermaid
flowchart LR
    A[Estructura del Salmo] --> B[150 palabras, 638 letras]
    B --> C[Tres patriarcas: Abraham, Isaac, Jacob]
    C --> D[Patrón de doble alabanza]
    D --> E[Poteaj et iadeja: apertura de manos]
    E --> F[Ratzón: voluntad como canal]
    F --> G[Dificultades como sustento divino]
    G --> H[Protocolo de recitación]
    H --> A
```
...
flowchart LR
    subgraph I_Do["I Do (Instructor)"]
        direction TB
        A1[Estructura: 150 palabras, 638 letras] --> A2[Patriarcas: valor numérico de abundancia] --> A3[Doble alabanza: espiritual y material] --> A4[Poteaj: abrir manos y recibir]
    end
    
    subgraph We_Do["We Do (Colaborativo)"]
        direction TB
        B1[Equipo: analizar estructura del salmo] --> B2[Interpretar: 638 letras y los patriarcas] --> B3[Diseñar: recitación con intención] --> B4[Revisar: práctica diaria]
    end
    
    subgraph You_Do["You Do (Independiente)"]
        direction TB
        C1[Construir: mapa numérico del salmo] --> C2[Definir: momento y postura de recitación] --> C3[Diseñar: protocolo personal de apertura] --> C4[Aplicar: 21 días de práctica]
    end
...
```mermaid
flowchart TD
    A[Salmo 145] --> B[150 palabras]
    A --> C[638 letras]
    B --> D[Poder total de los Salmos]
    C --> E[Valor numérico de los patriarcas]
    E --> F[Abraham]
    E --> G[Isaac]
    E --> H[Jacob]
    F --> I[Abundancia]
...
|----------|-------------|
| 150 palabras | Corresponde al número total de Salmos en la tradición judía |
| Simbología | El Salmo 145 concentra el poder de todos los Salmos en uno solo |
| Implicancia práctica | No es un salmo más. Es un salmo portal |
...
|----------------|---------|
| Orden alfabético | Alef, Bet, Guimel, Dalet, etc. |
| Verso clave | Uno de los versos está diseñado para invocar el sustento divino ante cualquier caída |
| Enseñanza | Las dificultades no son accidentes. Son sostenidas por Dios para transformarse en crecimiento |

### 1.5 El Salmo 145 como síntesis espiritual
...
class Salmo145:
    def __init__(self):
        ...
        self.estructura = "Alefbet completo"

    def resumen(self):
        return {
            "poder": f"{self.palabras} palabras = totalidad de los Salmos",
            "abundancia": f"{self.letras} letras = valor de los patriarcas",
            "estructura": self.estructura,
        }

    def mensaje_central(self):
        return "Dios siempre da. Nuestra limitación es la capacidad de recibir."
```

### 1.6 I Do — Explorar la estructura numérica

**Objetivo:** comprender la arquitectura espiritual del Salmo 145.

| Paso | Acción | Resultado |
|------|--------|-----------|
| 1 | Leer el salmo completo una vez | Contacto inicial |
| 2 | Contar 150 palabras o subrayar versos | Conciencia de la estructura |
| 3 | Investigar el valor numérico de Abraham, Isaac y Jacob | Entender el 638 |
| 4 | Identificar el verso que habla del sustento en la caída | Verso pivote |
| 5 | Escribir una frase sobre qué significa para vos | Aplicación personal |

### 1.7 We Do — Conectar estructura con cotidianidad
...
```mermaid
flowchart TD
    A[Abundancia infinita] --> B{¿Llega la bendición?}
    B -->|Canal abierto| C[Recepción amplia]
    B -->|Canal cerrado| D[Escasez percibida]
    C --> E[Gratitud y circulación]
    D --> F[Queja y contracción]
    E --> G[Más abundancia]
    F --> H[Más escasez]
```

### 2.2 La mano abierta como símbolo
...
### 2.4 Protocolo de apertura de manos
...
### 2.5 Errores comunes en la apertura a la abundancia
...
### 2.6 I Do — Practicar el protocolo Poteaj

**Objetivo:** experimentar la apertura corporal como parte de la práctica.

| Paso | Acción | Resultado |
|------|--------|-----------|
| 1 | Sentarse en silencio 2 minutos | Centramiento |
| 2 | Leer el verso en hebreo, fonética o español | Contacto |
| 3 | Abrir las manos simbólicamente | Postura |
| 4 | Respirar 3 veces manteniendo la apertura | Profundización |
| 5 | Escribir qué aparece | Materializar |

### 2.7 We Do — Diseñar un ritual de abundancia
...
### 2.8 You Do — Tu práctica de Poteaj
...
```mermaid
flowchart TD
    A[Veo un hecho cotidiano] --> B{¿Cómo lo leo?}
    B -->|Solo material| C[Historia superficial]
    B -->|Doble alabanza| D[Raíz espiritual + manifestación]
    D --> E[Abundancia en lo cotidiano]
    C --> F[Sorpresa angustiante]
    E --> G[Confianza y dirección]
```

### 3.2 Patrón de doble alabanza
...
### 3.3 Aplicación cotidiana del patrón
...
### 3.4 Ejemplos prácticos de doble lectura
...
### 3.5 I Do — Leer un hecho con doble alabanza

**Objetivo:** transformar una experiencia reciente en material espiritual.

| Paso | Acción | Resultado |
|------|--------|-----------|
| 1 | Elegir un hecho reciente que te afectó | Material de trabajo |
| 2 | Escribir la lectura material (lo obvio) | Superficie |
| 3 | Escribir la lectura espiritual (qué pide) | Profundidad |
| 4 | Escribir una acción de apertura | Propósito |
| 5 | Agregar una alabanza consciente | Cierre |

### 3.6 We Do — De dificultad a crecimiento
...
### 3.7 You Do — Tu mapa de doble alabanza
...
```mermaid
flowchart TD
    A[Caída o dificultad] --> B{¿Qué hago?}
    B -->|Huyo| C[Sufrimiento repetido]
    B -->|Enfrento con conciencia| D[Luz transformada]
    D --> E[Crecimiento espiritual]
    C --> F[Estancamiento]
```

### 4.2 Reencuadre de la dificultad
...
| "No tengo fuerzas" | "La dificultad pide nuevas herramientas" |
...
### 4.3 Protocolo frente a la dificultad
...
### 4.4 I Do — Reencuadrar una dificultad actual

**Objetivo:** cambiar la relación con una experiencia dolorosa.

| Paso | Acción | Resultado |
|------|--------|-----------|
| 1 | Escribir la dificultad sin filtro | Material |
| 2 | Identificar la emoción dominante | Punto de entrada |
| 3 | Reemplazar la emoción por una pregunta | Apertura |
| 4 | Escribir una acción de crecimiento | Propósito |
| 5 | Cerrar con gratitud por el aprendizaje | Cierre |

### 4.5 We Do — Sostener la dificultad en comunidad
...
### 4.6 You Do — Tu dificultad transformada
...
```mermaid
flowchart TD
    A[Protocolo de recitación] --> B[Mañana: 2 veces]
    A --> C[Tarde: 1 vez]
    A --> D[Noche: evitar]
    B --> E[Intención consciente]
    C --> E
    E --> F[Apertura de manos en Poteaj]
    F --> G[Abundancia circulando]
    G --> H[Gratitud y recepción]
```
...
### 5.5 Errores comunes en la recitación
...
### 5.6 I Do — Diseñar tu rutina de recitación

**Objetivo:** crear una práctica sostenible.

| Paso | Acción | Resultado |
|------|--------|-----------|
| 1 | Elegir horario de mañana 1 | Constancia |
| 2 | Elegir horario de mañana 2 | Profundización |
| 3 | Elegir horario de tarde | Cierre del día |
| 4 | Definir postura para Poteaj | Protocolo corporal |
| 5 | Definir momento de gratitud posterior | Cierre |

### 5.7 We Do — Revisar una semana de práctica
...
### 5.8 You Do — Tu protocolo personal de 21 días
...
| **HDC para el salmo** | Recitación 3 veces al día | Rutina espiritual sostenible |
...
1. **Aplica**: ¿Por qué 150 palabras y 638 letras convierten al Salmo 145 en una síntesis de poder?
2. **Analiza**: ¿Qué significa que Poteaj et iadeja sea el versículo pivote de la abundancia?
3. **Diseña**: Escribí tu protocolo de recitación: horario, postura, verso foco y gratitud posterior.
